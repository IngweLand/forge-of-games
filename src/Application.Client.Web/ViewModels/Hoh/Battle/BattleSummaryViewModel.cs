...
public class BattleSummaryViewModel
{
    ...
    public IReadOnlyCollection<BattleSquadBasicViewModel> EnemySquads { get; init; } = [];
    public required int Id { get; init; }
    public required string PerformedAt { get; init; }

    public required IReadOnlyCollection<BattleSquadBasicViewModel> PlayerSquads { get; init; } = [];
