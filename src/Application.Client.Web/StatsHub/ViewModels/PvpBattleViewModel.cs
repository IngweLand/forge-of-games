...
public class PvpBattleViewModel
{
    ...
    public required IReadOnlyCollection<BattleSquadBasicViewModel> PlayerUnits { get; init; }
    public required IReadOnlyCollection<BattleSquadBasicViewModel> OpponentUnits { get; init; }
