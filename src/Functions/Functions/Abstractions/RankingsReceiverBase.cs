...
namespace Ingweland.Fog.Functions.Functions.Abstractions;

public abstract class RankingsReceiverBase(ILogger<RankingsReceiverBase> logger, IGameWorldsProvider gameWorldsProvider)
{
