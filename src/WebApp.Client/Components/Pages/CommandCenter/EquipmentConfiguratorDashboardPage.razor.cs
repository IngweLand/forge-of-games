...
public partial class EquipmentConfiguratorDashboardPage : FogPageBase
{
    ...
    [Inject]
    private IEquipmentConfiguratorAnalyticsService AnalyticsService { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        AnalyticsService.TrackEvent(AnalyticsEvents.OPEN_EQUIPMENT_CONFIGURATOR_DASHBOARD);
    }
