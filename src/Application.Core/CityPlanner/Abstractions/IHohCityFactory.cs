...
public interface IHohCityFactory
{
    ...
    HohCity Create(string id, CityId inGameCityId, string ageId, string name, IEnumerable<CityMapEntity> entities,
        IEnumerable<CityMapEntity> inventoryBuildings, IReadOnlyCollection<HohCitySnapshot> snapshots,
        IEnumerable<string> expansions, IEnumerable<string> premiumExpansions, int cityPlannerVersion,
