...
public class HeroDtoFactory(IUnitDtoFactory unitDtoFactory, IHohGameLocalizationService localizationService)
    : IHeroDtoFactory
{
        ...
        HeroAbilityDto ability, HeroUnitType heroUnitType)
    {
        return new HeroDto
        {
            ...
            BaseSupportUnit = unitDtoFactory.Create(baseSupportUnit, unitStatCalculationData, unitBattleConstants,
                heroUnitType),
